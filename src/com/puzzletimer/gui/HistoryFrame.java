...
public class HistoryFrame extends JFrame {
    ...
    private void createComponents() {
        ...
        // labelGraph
        add(new JLabel(identifier("history.graph")), "span, wrap");
        ...
        // labelStatistics
        add(new JLabel(identifier("history.statistics")), "span, wrap");
        ...
        // buttonAddSolutions
        this.buttonAddSolutions = new JButton(identifier("history.add_solutions"));
        add(this.buttonAddSolutions, "growx, top, split 5, flowy");

        // buttonEdit
        this.buttonEdit = new JButton(identifier("history.edit"));
        this.buttonEdit.setEnabled(false);
        add(this.buttonEdit, "growx, top");

        // buttonRemove
        this.buttonRemove = new JButton(identifier("history.remove"));
        this.buttonRemove.setEnabled(false);
        add(this.buttonRemove, "growx, top");

        // buttonSelectSession
        this.buttonSelectSession = new JButton(identifier("history.select_session"));
        add(this.buttonSelectSession, "growx, top, gaptop 16");

        // buttonSelectNone
        this.buttonSelectNone = new JButton(identifier("history.select_none"));
        add(this.buttonSelectNone, "growx, top, wrap");

        // buttonOk
        this.buttonOk = new JButton(identifier("history.ok"));
    ...
    private void updateTable(Solution[] solutions) {
        ...
        tableModel.addColumn(identifier("history.#"));
        tableModel.addColumn(identifier("history.start"));
        tableModel.addColumn(identifier("history.time"));
        tableModel.addColumn(identifier("history.penalty"));
        tableModel.addColumn(identifier("history.scramble"));
