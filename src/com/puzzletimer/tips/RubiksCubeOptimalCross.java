...
public class RubiksCubeOptimalCross implements Tip {
    ...
    public String getTipDescription() {
        return identifier("tip.RUBIKS-CUBE-OPTIMAL-CROSS");
    }
    ...
    public String getTip(Scramble scramble) {
        ...
        tip.append(identifier("tip.RUBIKS-CUBE-OPTIMAL-CROSS.optimal_cross_on_u") + ":\n");
        ...
        // cross on D
        State stateD = state;
        tip.append(identifier("tip.RUBIKS-CUBE-OPTIMAL-CROSS.optimal_cross_on_d") + ":\n");
        ...
        tip.append(identifier("tip.RUBIKS-CUBE-OPTIMAL-CROSS.optimal_cross_on_l") + ":\n");
        ...
        tip.append(identifier("tip.RUBIKS-CUBE-OPTIMAL-CROSS.optimal_cross_on_r") + ":\n");
        ...
        tip.append(identifier("tip.RUBIKS-CUBE-OPTIMAL-CROSS.optimal_cross_on_f") + ":\n");
        ...
        tip.append(identifier("tip.RUBIKS-CUBE-OPTIMAL-CROSS.optimal_cross_on_b") + ":\n");
